...
export const loadChoresSuccess = createAction('[Chores] Load Chores Success', props<{ chores: IChoreReadRequest }>()); // represents the actual data emitted by the observable hence it's not an observable type but it's actual data.
