...
export const selectChoreState = createFeatureSelector<ChoreState>('selectedChore');

export const selectChores = createSelector(selectChoresState, (state: ChoresState) => state.chores);
