...
import { loadChores, setSkipAndTake, loadChoresSuccess, createChore, createChoreSuccess, loadChoreById, loadChoreByIdSuccess } from "./chores.actions";
...
this.actions$.pipe(
  ...
  mergeMap((action) =>  //merge streams together into one
